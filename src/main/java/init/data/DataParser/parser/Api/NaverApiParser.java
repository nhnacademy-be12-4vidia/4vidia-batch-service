...
import init.data.DataParser.DTO.NaverApiResponseDto;
import init.data.DataParser.DTO.NaverParsingDto;
...
public class NaverApiParser {
  ...
  public void searchAndSaveBooks(String keyword) {
    ...
    try {
      ...
      String apiUrl = "https://openapi.naver.com/v1/search/book.json?query=%s".formatted(encodedKeyword);
      ...
      for (NaverParsingDto dto : naverApiResponseDto.getItems()) {
        ...
        Book book = Book.builder()
            ...
            .publishedDate(LocalDate.parse(dto.getPubdate(), Formatter.NAVER_DATE_FORMATTER))
            .build();
