package com.nhnacademy.book_data_batch.batch.aladin.processor;
...
import com.nhnacademy.book_data_batch.batch.aladin.exception.DailyQuotaExceededException;
...
public class AladinEnrichmentProcessor implements ItemProcessor<BookEnrichmentTarget, EnrichmentResultDto> {
    ...
    public AladinEnrichmentProcessor(
            BookRepository bookRepository,
            EntityManager entityManager,
            AladinApiClient aladinApiClient,
            AladinBookMapper bookMapper,
            AladinAuthorExtractor authorExtractor,
            CategoryTagExtractor tagExtractor,
            AladinQuotaService quotaService,
            String apiKey,
            int partitionIndex) {
