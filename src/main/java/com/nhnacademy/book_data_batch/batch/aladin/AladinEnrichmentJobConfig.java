package com.nhnacademy.book_data_batch.batch.aladin;

import com.nhnacademy.book_data_batch.batch.aladin.client.AladinApiClient;
...
import com.nhnacademy.book_data_batch.batch.aladin.extractor.AladinAuthorExtractor;
import com.nhnacademy.book_data_batch.batch.aladin.extractor.CategoryTagExtractor;
import com.nhnacademy.book_data_batch.batch.aladin.handler.EnrichmentSaveHandler;
import com.nhnacademy.book_data_batch.batch.aladin.listener.QuotaExhaustedStepListener;
import com.nhnacademy.book_data_batch.batch.aladin.mapper.AladinBookMapper;
import com.nhnacademy.book_data_batch.batch.aladin.partitioner.AladinEnrichmentPartitioner;
import com.nhnacademy.book_data_batch.batch.aladin.processor.AladinEnrichmentProcessor;
import com.nhnacademy.book_data_batch.batch.aladin.reader.AladinEnrichmentReader;
import com.nhnacademy.book_data_batch.batch.aladin.writer.AladinEnrichmentWriter;
...
/**
 * <pre>
 * AladinEnrichmentJobConfig: Aladin API를 이용한 도서 정보 보강 배치 Job 설정
...
public class AladinEnrichmentJobConfig {
    ...
    private static final String JOB_NAME = "aladinEnrichmentJob";
