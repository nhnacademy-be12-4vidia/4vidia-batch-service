package com.nhnacademy.book_data_batch.batch.enrichment.client;

import com.nhnacademy.book_data_batch.batch.enrichment.dto.AladinItemDto;
import com.nhnacademy.book_data_batch.batch.enrichment.dto.AladinResponseDto;
import com.nhnacademy.book_data_batch.batch.enrichment.exception.RateLimitExceededException;
...
public class AladinApiClient {
    ...
    private static final String OPT_RESULT = "bookinfo";  // 상세 정보 포함
    ...
    private String buildUrl(String isbn13, String apiKey) {
        return UriComponentsBuilder.fromUriString(BASE_URL)
                ...
                .queryParam("OptResult", OPT_RESULT)
                .build()
                .toUriString();
    }
}
